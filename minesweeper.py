...
class Minesweeper():
    ...
    def __init__(self, HEIGHT=8, WIDTH=8, MINES=8, mines_loc=None):
    ...
    def won(self):
        ...
        """
        return (self.mines_found == self.mines) or (len(self.revealed) == (self.HEIGHT*self.WIDTH-self.MINES))
